...
if __name__ == "__main__":
    ...
    # )
    modelo_ppo = PPO.load("ppo_10ast_2obs_split", env=env_diff1)

    modelo_ppo.learn(
        total_timesteps=500000,
        tb_log_name="ppo_10ast_2obs_split",
        callback=callback,
        reset_num_timesteps=False,
        progress_bar=True
    )

    modelo_ppo.save("ppo_10ast_2obs_split")
